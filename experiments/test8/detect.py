...
for video_file in video_files:
    ...
    # Czytanie pierwszej klatki i ustawienie jej jako referencyjna
    ...
    if ret:
        ...
        while True:
            ...
            first_detection_area = first_frame_gray[y_start:y_start+detection_height, x_start:x_start+detection_width]
            frame_diff = cv2.absdiff(detection_area, first_detection_area)
